...
class AppCore:
    ...
    def show_raise_window(
        ...
        if _print:
            assert not isinstance(instance, AboutWindow)
    ...
    def job_post_dialog(self) -> None:
        ...
        for job_post in self.selected_new_job_posts:
            # https://github.com/python-qt-tools/PyQt5-stubs/issues/147
            self.dialog_groupbox = QtWidgets.QGroupBox(objectName="job_post_box")  # type: ignore
...
class UrlDialog:
    ...
    def __init__(self, json_content: upwatch.JsonContent) -> None:
        ...
        # https://github.com/python-qt-tools/PyQt5-stubs/issues/142
        self.window.setWindowFlags(QtCore.Qt.FramelessWindowHint | QtCore.Qt.WindowStaysOnTopHint)  # type: ignore
